...
def main(): 
    ...
    while text != '/':
        quant = 0
        text = input("What is your order, select from the order codes given, 'americano', 'brewedcoffee', 'cappuccino', 'dalgona', 'espresso', 'frappuccino'.")
        if text == '/':
            break
            ...
            pass
        try: 
            quant = int(input("How much do you wish to order?"))
        except:
